            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result))
                    {
                        ...
                        echo "<td>
                            <button type='button' class='btn-edit user' onclick='window.location.href=\"edit.php?id=$user_data[id]\";'>
                                <ion-icon name='pencil'></ion-icon>
                            </button>
                            <button type='button' class='btn-del' onclick='window.location.href=\"delete.php?id=$user_data[id]\";'>
